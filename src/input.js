    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {this.state.input !== '' ? (
            <div style={divS}>
              <button type="button" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} tabIndex="3" />
              <button type="button" className="fa fa-search" style={inputSearch} onClick={this.search} tabIndex="2" />
            </div>
          )
            : <button type="button" className="fa fa-search hover" tabIndex="2" /> }
        </form>
      </div>
    );
  }
